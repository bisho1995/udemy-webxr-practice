...
class ARButton {
  ...
  showStartAR(button) {
    ...
    function onSessionStarted(session) {
      ...
      if (typeof self.onSessionStart === "function") self.onSessionStart();
    }
    ...
    button.onclick = function () {
      if (currentSession === null) {
        ...
        navigator.xr
          ...
          .catch((err) => {
            console.error(
              `[ARButton.buttonOnClick] immersive-ar Failed ${err}`
            );
            alert("[ARButton.buttonOnClick] immersive-ar Failed");
          });
      } else {
        currentSession.end();
      }
